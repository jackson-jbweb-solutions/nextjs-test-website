...
export default function ProductsPage() {
    ...
    return (
        <div className="container mx-auto py-10 px-4">
            <h1 className="text-3xl font-bold mb-4">Hello from Products</h1>
            <p>This is the products page. Content will be added soon.</p>
            <button
                type="button"
                onClick={() => setOpen(true)}
                className="mt-4 inline-flex justify-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
                Open Modal
            </button>
